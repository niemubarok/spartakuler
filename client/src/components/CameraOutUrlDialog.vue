      ...
      <q-item>
        ...
        <q-item-section>
          <q-item-label
            ...
            >URL CCTV Kamera Keluar</q-item-label
          >
        </q-item-section>
      </q-item>
      <q-separator inset />
...
onMounted(async () => {
  cameraOutUrl.value = useSettingsStore().cameraOutUrl;
});

const onSaveSettings = () => {
  useSettingsStore().cameraOutUrl = cameraOutUrl.value;
  ls.set("cameraOutUrl",cameraOutUrl.value);
