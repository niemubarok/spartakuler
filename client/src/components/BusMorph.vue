<template>
  <div>
    ...
    <q-card
      flat
      v-morph:struk:bus:100.tween="morphStore.morphBusModel"
    ...
    >
      ...
      <q-card-section class="text-subtitle1">
        ...
        <q-input
          ...
          autofocus
          @keydown.enter="
            [morphStore.nextBusMorph(), transaksiStore.setCheckIn(true)]
          "
        >
      ...
      <!-- <q-card-actions align="right">
        <q-btn flat label="Next" @click="morphStore.nextBusMorph()" />
      </q-card-actions> -->
    </q-card>
  </div>
</template>
